...
if name == "Sambhav": #Replace the "Sambhav" for your name
	YouAreAwesome();
	bad = 0

elif name == "Sambhav Saggi":#Replace the "Sambhav Saggi" with another option for a name
	YouAreAwesome();
	bad = 0
...
if bad == 0:
	...
	print ("If you are not Sambhav The Great, I don't recommend trying this again")#replace "Sambhav The Great" with whatever you want.
	YouLose();